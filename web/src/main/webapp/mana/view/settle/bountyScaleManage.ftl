...
<div class="">
    <p class="p-title">规则配置 > 奖励金模式 > 新增</p>
    <div class="select-condition-box">
        <div class="select-condition-item">
            <span>保险公司</span>
            <select class="js-insurance-company">
            <#if allCompanyList ??>
        ...
        <div class="dispose">
            <input class="opa-radio" checked type="checkbox" name="store" value="2">门店配置
            <input class="opa-radio" type="checkbox" name="area" value="1">地区配置
        </div>
...
<script type="text/html" id="areaBoxTemplate">
    ...
    <ul class="area-dispose-item js-item">
        ...
        <li>
            <input type="checkbox" class="opa-radio" value="{{region.regionCode}}">
...
<script type="text/javascript" src="/mana/js/settle/bountyScaleManage.js"></script>
